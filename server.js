...
app.use(cors({
  origin: ["https://phenixdeals.vercel.app"],//Local Host: to access the front-end side through this URL
      ...
      if (user) {
        bcrypt.compare(password, user.password, (err, response) => {
          ...
          if (response) {
            ...
            res.cookie('token', token, { sameSite: 'None', secure: true }); //Pour store le token dans le cookie res.cookie('nameOfToken', value)
